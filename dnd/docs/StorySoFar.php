			...
			$content = <<<"CONTENT"
				<h1 id="top">Our Story This Far</h1>
					<p>
						...
						killing what to us was the creation of science itsel; an abomination that was stiched together with flesh and metal.
						<br/><br/><br/>
						[Sept 15, 115 PAR]
						<br/><br/>
						...
						apocalypse known as Titans. For some reason, the Titans have targeted any attempt at civilization outside of the main city boundaries.
						...
						we asked for an assignment to gain thier trust. We were commissioned to retrieve a drive with some important scientific data that predates the post-apocalyptic record. 
						After finding the disk, instead of returning to Recon Force IV, we instead visited the sharks. We copied the data over to them for a new pair of car batteries
