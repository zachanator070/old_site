...
<?php
	...
	class DatabaseAccess{
		...
		public function updateCharacter($character){
			...
			$queries[2]="UPDATE info SET player='".$character->player."', class='".$character->class."', level =".$character->level.", race='".$character->race."', age=".$character->age.", gender='".$character->gender."', background='".mysqli_real_escape_string($this->con,$character->background)."' where name ='".$character->name."'"; 
